...
function updatePlate2(data) {
	document.getElementById('bwdplate').innerHTML = data;
}
...
function lockPlate2(state,data) {
	if ( state == true ) {
		document.getElementById('bwdplate').style.background = 'linear-gradient( to bottom, rgb( 220, 0, 40 ), rgb( 90, 0, 0 ) )';
	} else {
		document.getElementById('bwdplate').style.background = 'linear-gradient( to bottom, rgb( 0, 150, 0 ), rgb( 0, 75, 0 ) )';
	}
}
