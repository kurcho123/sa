...
Config.CooldownTime = 20
Config.MinimumHouseRobberyPolice = 0
Config.MinimumTime = 22
Config.MaximumTime = 5
Config.Rewards = {
    [1] = {
        ["cabin"] = {"rolex", "gold_ring", "diamond_ring", "goldchain", "emerald", "ruby", "puregoldcoin"},
        ["kitchen"] = {"microwave", "coffeemaker", "goldchain"},
        ["chest"] = {"rolex", "gold_ring", "diamond_ring", "goldchain", "emerald", "ruby", "puregoldcoin"},
        ["livingroom"] = {"art", "tv", "telescope", "puregoldcoin"},
    }
}
