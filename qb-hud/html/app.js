...
const playerHud = {
  ...
  methods: {
    hudTick(data) {
      ...
      this.isRadioTalking = data.isRadioTalking;
      ...
      } else if (data.engine <= 50 && data.engine >= 35 ) {
      ...
      if (data.talking && data.isRadioTalking) {
      ...
      if (data.voice >= 10.0) {
        ...
        this.voiceIcon = 'fas fa-bullhorn';
      }
      if (data.cruise === true) {
        this.cruise = 1;
      ...
      if (data.bleed > 0 ) {
        this.showBleed = true;
        bleed = data.isBleeding;
      } else {
        this.showBleed = false;
      }
      if (data.toxicity > 0 ) {
        this.showToxicity = true;
      } else {
        this.showToxicity = false;
      }
      if (data.isPaused === 1) {
        this.show = false;
      }
