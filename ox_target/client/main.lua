...
local function enableTargeting()
    if isDisabled or isActive or IsNuiFocused() or IsPauseMenuActive() or IsPedInAnyVehicle(PlayerPedId()) then return end
        ...
        if hit and distance < 7 then
            ...
            for _, v in pairs(options) do
                ...
                for i = 1, optionCount do
                    ...
                    if (option.distance and distance > option.distance) or (distance > 3.0) then
                        hide = true
                    end
