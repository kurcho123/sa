...
Config.Vehicles = {
    ["vehicles"] = {
        [`tow`] = "Flatbed",
        [`flatbedm2`] = "Heavy Flatbed",
        [`hvywrecker`] = "Heavy Wrecker",
        [`20ramdot`] = "SADOT Ram 1500",
        [`t680`] = "Semi Truck",
        [`forklift2`] = "Forklift Two",
    },
    ["trailers"] = {
        [`tr2`] = "Car Hauler",
        [`trflat`] = "Flatbed",
        [`tvtrailer`] = "Lowboy",
        [`trailersmall`] = "Single Car Trailer",
    },
}
...
Config.Locations = {
    ["map"] = {
        ["city"] = {
            label = "SADOT HQ",
            coords = vector3(819.44, -798.75, 26.28),
        },
        ["sandy"] = {
            label = "SADOT Harmony Depot",
            coords = vector3(1186.35, 2637.94, 38.44),
        }
    },
    ["vehicle"] = {
        ["city"] = {
            coords = vector4(825.81, -797.5, 25.98, 92.25),
        },
        ["sandy"] = {
            coords = vector4(1164.8, 2639.26, 38.03, 355.85),
        },
    },
    ["towspots"] = {
