...
-- Upper worth per bag
Config.BagUpperWorth = 35

-- Lower worth per bag
Config.BagLowerWorth = 25

-- Minimum bags per stop
Config.MinBagsPerStop = 4
...
Config.Locations = {
    ["main"] = {
        label = "PUBLIC JOB: Garbage Depot",
        coords = vector3(-313.84, -1522.82, 27.56),
    },
    ["vehicle"] = {
        label = "Garbage Truck Storage",
        coords = vector4(-325.41, -1524.38, 27.54, 267.61),
    },
    ["paycheck"] = {
    ...
    ["trashcan"] ={
        ...
        [2] = {
            name = "grovestreet",
            coords = vector4(3.12, -1823.22, 25.36, 57.93),
            pz = vector3(3.12, -1823.22, 25.36),
            length = 4.0,
            width = 6.8,
            heading = 57.93,
            minZ = 24.63,
        ...
        [12] = {
            name = "eclipseblvd",
            coords = vector4(-623.65, 293.52, 82.06, 299.91),
            pz = vector3(-623.52, 293.53, 82.06),
            length = 4.0,
            width = 6.8,
            heading = 266.81,
            minZ = 81.0,
