...
Config.BlowUpChance = 10 -- percentage for chance of engine explosion
...
Config.refuelCostMethanol = 350 -- methanol can refuel
Config.RacerMultiplier = 1.15 -- Fuel Racer
Config.DragMultiplier = 2.25 -- Fuel Racer
...
Config.RaceStations = {
    ...
    [2] = { 
        zones = {
            vector2(-60.61, -2546.04),
            vector2(-82.56, -2530.36),
            vector2(-73.44, -2517.89),
            vector2(-52.40, -2533.53)
        },
        minZ = 5.0,
        maxZ = 8.3
    },
    [3] = { 
        zones = {
            vector2(-2592.32, 3305.27),
            vector2(-2622.73, 3323.00),
            vector2(-2618.89, 3329.94),
            vector2(-2588.45, 3312.43)
        },
        minz = 32.00,
        maxz = 35.11,
    },
    [4] = { 
        zones = {
            vector2(917.2, -2337.16),
            vector2(908.49, -2336.16),
            vector2(915.66, -2347.99),
            vector2(907.65, -2347.17)
        },
        minz = 20.00,
        maxz = 24.00,
    },
...
Config.GasStations = { -- gas station polyzones
    ...
    [27] = { 
        zones = {
            vector3(817.33, -791.93, 26.19),
            vector3(817.21, -787.04, 26.19),
            vector3(804.22, -787.23, 26.21),
            vector3(803.66, -792.20, 26.22),
        },
        minz = 25.00,
        maxz = 27.00,
    },
    [28] = { 
        zones = {
            vector2(-1128.5050048828, -1974.1710205078),
            vector2(-1126.6297607422, -2008.0716552734),
            vector2(-1104.6192626953, -2007.8968505859),
            vector2(-1104.9139404297, -1973.9578857422)
        },
        minz = 13.06,
        maxz = 13.17,
    },
