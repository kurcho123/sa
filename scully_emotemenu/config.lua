Config = {
    ...
    -- Set this to '' to disable the key.
    CrouchKey = '', -- List of keys here: https://docs.fivem.net/docs/game-references/input-mapper-parameter-ids/keyboard/
    -- Set this to '' to disable the key.
    ...
    -- Set this to '' to disable the key.
    MenuKeybind = '', -- List of keys here: https://docs.fivem.net/docs/game-references/input-mapper-parameter-ids/keyboard/
    -- You can change the menu position here.
    MenuPosition = 'top-right', -- (top-left, top-right, bottom-left, bottom-right)
    -- You can change the notification position here
    NotificationPosition = 'top-right', -- (top, bottom, top-left, top-right, bottom-left, bottom-right)
    -- You can change the help alert position here
    HelpAlertPosition = 'right-center', -- (right-center, left-center, top-center)
    -- Set this to '' to disable the key.
    RagdollKeybind = 'j', -- List of keys here: https://docs.fivem.net/docs/game-references/input-mapper-parameter-ids/keyboard/
    -- Set this to '' to disable the key.
