...
BikerClubhouse1 = {
    ...
    LoadDefault = function()
        ...
        BikerClubhouse1.Furnitures.Set(BikerClubhouse1.Furnitures.B, 3)
        BikerClubhouse1.Decoration.Set(BikerClubhouse1.Decoration.B)
        BikerClubhouse1.Mural.Set(BikerClubhouse1.Mural.heart)

        BikerClubhouse1.ModBooth.Set(BikerClubhouse1.no_mod_booth)
