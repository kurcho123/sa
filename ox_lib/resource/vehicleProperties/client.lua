...
function lib.getVehicleProperties(vehicle)
    if DoesEntityExist(vehicle) then
        local Vehiclebag = Entity(vehicle)
        ...
        return {
            ...
            tunerData         = Vehiclebag.state.tunerData or 'stock',
            powerDecrease     = Vehiclebag.state.powerDecrease or 0,
            engineSerial      = Vehiclebag.state.engineSerial or tostring(RandomInt(3) .. RandomStr(3) .. RandomInt(3)):upper(),
            nitrousSystem     = Vehiclebag.state.nitrousData or false,
            hasEngine         = Vehiclebag.state.hasEngine or true,
        }
    end
end
...
function lib.setVehicleProperties(vehicle, props)
    ...
    TriggerEvent('QBCore:Client:SetTunerData', props.tunerData or 'stock', props.engineSerial, props.nitrousSystem or false, props.powerDecrease or 0, vehicle, props.hasEngine) -- Universal Event Sent 
