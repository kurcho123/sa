...
Config.BoatPrice = 150                                          -- Price of the boat rental, price is divided when boat is returned
Config.TestFish = false 										-- Test Fish with commands /startfish or /spawnfish
Config.Skillbar = "skillcheck"                             	-- Must choose one of the avalible skillbars ["reload-skillbar","np-skillbar","qb-skillbar"]
Config.targetExport = "qb-target"                               -- The name of the Target export you are using ["qb-target", "qtarget", "bt-target"]

Config.PearlsSellsBlip = vector3(-51.14, 1910.0, 195.36)  -- Blip to sell fish you have caught
...
-- Gear
Config.fishingRodPrice = 150                                     -- Price of a fishing rod
...
-- Regular Fish
Config.mackerelPrice     = 10                                    -- Price of Mackerel
Config.codfishPrice      = 20                                   -- Price of Cod
Config.bassPrice         = 30                                   -- Price of Normal Fish
...
Config.sharktigerPrice   = 150                                  -- Price of Tigersharks
Config.sharkhammerPrice  = 250                                  -- Price of Hammerhead Sharks
Config.killerwhalePrice  = 500                                  -- Price of Killer whales

-- Rewards
Config.smallLootboxCash = 100                                  	-- Price of the cash reward for the "Metal Box"
Config.smallLootboxReward = 'plastic'                           -- Item reward besides the "Corroded Key"

Config.largeLootboxRewards = {                                  -- Rewards found in the treasure chest (keep price = 0) // Amount set per restart based on the random value
    [1] = { name = "plastic", price = 0, count = math.random(2,5) },
	[2] = { name = "dirty_water_bottle", price = 0, count = math.random(1,3) },
	[3] = { name = "pearlscard", price = 0, count = 1, metadata = {["durability"] = 100} },
    [4] = { name = "carbon", price = 0, count = math.random(1,2) },
}
...
Config.PedList = {                                              -- Peds that will be spawned in (if you change a ped model here you need to also change the ped model in client/addons.lua qb-target exports)
	...
	-- 	coords = vector3(-656.06, 2456.31, 48.67),         -- Regular Fish Sells
	-- 	heading = 80.01,
	-- 	gender = "male",
