...
QBConfig.Money.PaycheckTimeout = 25 -- The time in minutes that it will give the paycheck
...
QBConfig.Player = {}
QBConfig.Player.MaxWeight = 90000 -- Max weight a player can carry (currently 120kg, written in grams)
QBConfig.Player.MaxInvSlots = 40 -- Max inventory slots for a player
QBConfig.Player.HungerRate = 7.2 -- Rate at which hunger goes down. -- BASED ON UPDATE INTERVAL!
QBConfig.Player.ThirstRate = 8.7 -- Rate at which thirst goes down.
...
QBConfig.Server.Discord = "discord.gg/paradoxgaming" -- Discord invite link
