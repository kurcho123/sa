    ...
    textEscaped() {
      ...
      s = s.replace(/{(\d+)}/g, (match, number) => {
        ...
        if (number == 0 && this.color) {
          ...
          if (this.color == 9) {
            var now = new Date();
            var dob = this.args.birthdate;
            var Fname = this.args.firstname;
            var Lname = this.args.lastname;
            var Licenseclass = this.args.type;
            if (Number(this.args.gender) == 1) {
              var sex = 'Female'
            } else {
              var sex = 'Male'
            }
            var identifier = this.args.citizenid;
            var pref = 'Citizen';
            ...
            <div class="license__state">San Andreas</div>
              ...
              <div class="license__row license__row--red license__row--exp">6/09/2029</div>
              ...
              <div class="license__row license__row--class">${Licenseclass}</div>
              ...
              <div class="license__row license__row--small license__row--iss">12/18/2021</div>
            </div>`;
          } 
