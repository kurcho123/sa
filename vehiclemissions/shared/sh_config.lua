...
Shared.FuelScript = 'ps-fuel' -- This is used for exports[Shared.FuelScript]:SetFuel(veh, 23.00), use ps-fuel if using Project Sloth version
Shared.Debug = true -- Server sided console prints
Shared.LaptopItem = 'prdxlaptop' -- Boostinglaptop item name

Shared.BoostInterval = 15 -- Amount of minutes between new boost contracts
Shared.BoostContractAmount = 1 -- Amount of contract created every Shared.BoostInterval minutes
...
Shared.MoneyType = 'crypto' -- The moneytype used to start a contract, make sure to edit the strings in the UI too in the app.js to fit your moneytype. i.e Change QBit to Cash
...
Shared.MinCops = 1 -- Minimum cops required for the server to send contracts if CopsRequired option enabled
...
Shared.PlayerContractsEnable = false -- Enable or disable player contract options.
Shared.PlayerContractChance = 5 -- %chance for a player to receive a Player Contract (if possible) else, get a normal type contract
Shared.PlayerContractRep = 1500 -- Minimum boostingrep required to get a chance to get a player contract
Shared.PlayerContractExpireTime = 30 -- Amount of minutes a player has to start a player contract
Shared.PlayerContractEligible = 4 -- Minimum amount of VIN scratched vehicles a player needs to have to be added to the pool
Shared.PlayerContractEligibleRequired = 20 -- Minimum amount of eligible VIN scratched vehicles required before creating player contracts
Shared.PlayerContractHacks = 15 -- Amount of hacks that need to be done for a player contract vehicle

Shared.Contracts = {
    ['D'] = { 
        vehicles = {'chino2', 'virgo', 'tornado5', 'yosemite', 'tampa', 'khamelion', 'kanjo', 'glendale2', 'primo2', 'intruder', 'stratum'}, -- You can always add more vehicles here
        ...
        maxRep = 100, -- Here you can change the min and max reputation thresholds for the different ranks
        price = {min = 1,  max = 1}, -- Buy-in price in crypto
        reward = {min = 3, max = 4}, -- Crypto rewarded after successful boost
        exp = {buyin = 0, payout = 10}, -- Boosting rep buyin and reward after successful boost
        hacks = 3, -- Amount of hacks required
        dropCops = 1, -- Minimum amount of cops required for a drop-off
        vinCops = 99, -- Minimum amount of cops required for a VIN-scratch
        expireTime = 1, -- Time in hours for the contract of this tier to expire
        vinPrice = 99999
    },
    ['C'] = {
        vehicles = {'nightshade', 'penumbra', 'ellie', 'imorgon', 'zion3', 'gt500', 'gauntlet', 'z190', 'gauntlet3', 'dominator'},
        locations = {
            [1] = {
        ...
        maxRep = 220,
        price = {min = 3,  max = 6},
        reward = {min = 17, max = 23},
        exp = {buyin = 5, payout = 17},
        hacks = 5,
        dropCops = 4,
        vinCops = 99,
        expireTime = 1,
    ...
    ['B'] = {
        vehicles = {'cogcabrio', 'penumbra2', 'tailgater2', 'stingergt', 'dominator7', 'remus', 'buffalo2', 'previon', 'banshee', 'dominator8', 'kuruma', 'gb200', 'astron'},
        locations = {
            [1] = {
        ...
        maxRep = 440,
        price = {min = 7,  max = 9},
        reward = {min = 26, max = 35},
        exp = {buyin = 12, payout = 24},
        hacks = 7,
        dropCops = 4,
        vinCops = 99,
        expireTime = 1,
    ...
    ['A'] = {
        vehicles = {'calico', 'massacro', 'tampa2', 'elegy', 'elegy2', 'jugular', 'vectre', 'komoda', 'feltzer2', 'sultan', 'mamba', 'drafter', 'vstr'},
        locations = {
            [1] = {
        ...
        maxRep = 696,
        price = {min = 12,  max = 18},
        reward = {min = 45, max = 55},
        exp = {buyin = 20, payout = 37},
        hacks = 8,
        dropCops = 4,
        vinCops = 99,
        expireTime = 1,
    ...
    ['S'] = {
        vehicles = {'turismor', 'massacro2', 'coquette4', 'comet6', 'paragon', 'tyrus', 'neo', 'emerus'},
        locations = {
            [1] = {
        ...
        maxRep = 997,
        price = {min = 20,  max = 30},
        reward = {min = 57, max = 67},
        exp = {buyin = 28, payout = 48},
        hacks = 10,
        dropCops = 6,
        vinCops = 99,
        expireTime = 1,
