...
Config.Cats = {
    ['cat1'] = {['coords'] = vector4(-573.9, -1056.29, 22.43, 115.15),['sitting'] = true}, --- Pizza Locations For Ped And Job
    ['cat2'] = {['coords'] = vector4(-574.01, -1054.86, 22.43, 155.19),['sitting'] = true},
    ...
    ['cat13'] = {['coords'] = vector4(-584.17, -1062.87, 23.37, 228.13),['sitting'] = true}
